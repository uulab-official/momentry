...
const styles = StyleSheet.create({ root: { flex: 1 }, searchRow: { flexDirection: 'row', paddingHorizontal: 16, paddingVertical: 12, gap: 9 }, searchBox: { flex: 1, height: 48, borderWidth: 1, borderRadius: 15, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 13 }, searchInput: { ...typography.body, flex: 1, height: '100%', paddingLeft: 8 }, clearSearch: { width: 36, height: 44, alignItems: 'flex-end', justifyContent: 'center' }, searchButton: { height: 48, minWidth: 58, borderRadius: 15, paddingHorizontal: 17, alignItems: 'center', justifyContent: 'center' }, searchButtonText: { ...typography.button, color: '#fff' }, help: { ...typography.caption, paddingHorizontal: 18, marginBottom: 4 }, list: { padding: 16, paddingBottom: 128 }, emptyList: { flexGrow: 1 }, resultHeader: { minHeight: 30, paddingBottom: 8, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, resultCount: typography.label, resultHint: typography.overline, result: { borderWidth: 1, borderRadius: 17, padding: 10, flexDirection: 'row', alignItems: 'center', gap: 12 }, cover: { width: 54, height: 72, borderRadius: 9 }, coverPlaceholder: { alignItems: 'center', justifyContent: 'center' }, resultText: { flex: 1, gap: 4 }, resultTitle: typography.itemTitle, empty: { alignItems: 'center', paddingHorizontal: 24, paddingVertical: 42, borderRadius: 18, gap: 7 }, emptyIcon: { width: 64, height: 64, borderRadius: 32, alignItems: 'center', justifyContent: 'center', marginBottom: 7 }, emptyTitle: typography.sectionTitle, emptyBody: { ...typography.body, textAlign: 'center' }, retry: { minHeight: 44, marginTop: 10, paddingHorizontal: 18, borderRadius: 14, alignItems: 'center', justifyContent: 'center' }, retryText: { ...typography.button, color: '#fff' }, manual: { position: 'absolute', left: 16, right: 16, height: 52, borderRadius: 16, borderWidth: 1.5, alignItems: 'center', justifyContent: 'center' }, manualText: typography.button, skeletonList: { padding: 16, gap: 10 }, skeletonHeader: { width: 72, height: 13, borderRadius: 7, marginBottom: 2 }, skeletonText: { flex: 1, gap: 9 }, skeletonTitle: { width: '78%', height: 18, borderRadius: 8 }, skeletonMeta: { width: '48%', height: 13, borderRadius: 7 } });
