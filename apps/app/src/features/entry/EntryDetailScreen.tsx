...
const styles = StyleSheet.create({ root: { flex: 1 }, center: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: 14 }, retry: { minHeight: 44, paddingHorizontal: 20, borderRadius: 14, alignItems: 'center', justifyContent: 'center' }, retryText: { ...typography.button, color: '#fff' }, content: { padding: 16, paddingBottom: 60 }, heroPressable: { marginBottom: 20 }, hero: { width: '100%', aspectRatio: 1.45, borderRadius: 24 }, placeholder: { marginBottom: 20, alignItems: 'center', justifyContent: 'center' }, meta: { flexDirection: 'row', gap: 10, alignItems: 'center' }, kind: typography.label, title: { ...typography.display, marginTop: 9 }, creator: { ...typography.label, marginTop: 6, fontWeight: '400' }, rating: { fontSize: 18, letterSpacing: 2, marginTop: 12 }, divider: { height: StyleSheet.hairlineWidth, marginVertical: 22 }, body: { fontSize: 16, lineHeight: 26, fontWeight: '400' }, skeletonHero: { width: '100%', aspectRatio: 1.45, borderRadius: 24, marginBottom: 20 }, skeletonMeta: { flexDirection: 'row', alignItems: 'center', gap: 10 }, skeletonKind: { width: 42, height: 16, borderRadius: 8 }, skeletonDate: { width: 88, height: 14, borderRadius: 7 }, skeletonTitle: { width: '78%', height: 31, borderRadius: 10, marginTop: 13 }, skeletonSubtitle: { width: '44%', height: 16, borderRadius: 8, marginTop: 10 }, skeletonDivider: { height: StyleSheet.hairlineWidth, marginVertical: 24 }, skeletonLine: { width: '100%', height: 16, borderRadius: 8, marginBottom: 13 }, skeletonLineShort: { width: '64%', height: 16, borderRadius: 8 } });
