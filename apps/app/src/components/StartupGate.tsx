...
const styles = StyleSheet.create({ root: { flex: 1, alignItems: 'stretch', justifyContent: 'center', paddingHorizontal: 34 }, logoSlot: { height: 260, alignSelf: 'center', alignItems: 'center', justifyContent: 'flex-end' }, logo: { width: 176, height: 176 }, title: { fontSize: 26, fontWeight: '900', letterSpacing: -0.7, marginTop: 4 }, tagline: { fontSize: 13, marginTop: 5 }, messageSlot: { marginTop: 34, marginBottom: 17 }, message: { fontSize: 14, textAlign: 'center', includeFontPadding: true }, progressSlot: { width: '100%', maxWidth: 330, height: 44, alignSelf: 'center' }, track: { height: 7, borderRadius: 5, overflow: 'hidden' }, fill: { height: 7, borderRadius: 5 }, percent: { textAlign: 'center', fontSize: 12, marginTop: 8, fontVariant: ['tabular-nums'] }, spinnerSlot: { height: 24 } });
