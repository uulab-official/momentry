...
const styles = StyleSheet.create({ root: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: 12, padding: 24 }, title: typography.screenTitle, link: typography.button });
